            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('barang' . '/' . $barang->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Nama </th><td> {{ $barang->nama }} </td></tr><tr><th> Deskripsi </th><td> {{ $barang->deskripsi }} </td></tr>
                                </tbody>
                            </table>
                        </div>
